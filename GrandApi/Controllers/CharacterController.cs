...
namespace GrandApi.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        [HttpPost("weapon")]
        public async Task<ActionResult<Character>> AddWeapon(Weapon request)
        {
        ...
        [HttpPost("skill")]
        public async Task<ActionResult<Character>> AddSkill(CharacterSkillDto request)
        {
